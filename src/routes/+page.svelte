...
<div class="relative flex justify-center">
	<div class="shadow-sm fixed top-0 z-20 w-full bg-gray-50">
	...
	<div class="container mx-auto flex flex-start px-8 md:flex-row flex-col items-center">
		<div class="flex flex-col align-middle text-left pr-10">
			...
			<p class="mb-8 leading-relaxed w-4/5">
				<!-- svelte-ignore a11y-missing-attribute -->
				Experience seamless classroom management with <a class="font-bold">Mwenzi</a>: Revolutionize
				your teaching experience with our web-based application that integrates
				<!-- svelte-ignore a11y-missing-attribute -->
			...
			<div class="flex justify-left">
				<a href="/Login">
					<button
						class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded-3xl text-lg font-medium"
						>Try Now
					</button>
				</a>
			</div>
			...
			<div class="p-4 lg:w-1/3">
				...
				>
					...
					<div class="flex-grow sm:pl-8">
						...
						<p class="mb-4">"Powering the unseen foundation that brings functionality to life"</p>
						<span class="inline-flex">
							<!-- svelte-ignore a11y-missing-attribute -->
							<a class="text-gray-500">
								<svg
