...
<body class=" bg-gray-100 w-screen h-screen">
    <header class="fixed top-0 w-full text-gray-700 bg-gray-50 border-t border-gray-100 shadow-sm body-font" style="z-index: 9999;">
      <div class="container mx-auto flex justify-between">
        <div class="flex w-full flex-row items-center justify-start px-5">
          ...
          <div class="ml-[50px] hidden space-x-10 lg:block">
            ...
            <a class="false py-[20px] text-sm " href="/..">Home</a>
            <!-- svelte-ignore a11y-invalid-attribute -->
            <a class="text-primary py-[29px] text-sm font-medium" href="/About-Us">About</a>
            <!-- svelte-ignore a11y-invalid-attribute -->
