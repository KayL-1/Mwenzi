<script>
  ...
  async function createClass() {
    ...
    if (querySnapshot.empty) {
      ...
      console.log(
        "A class with the same name already exists. Creation aborted."
      );
    }
  }
  ...
  async function displayClasses() {
    ...
    querySnapshot.forEach((doc) => {
        classArray.push(doc.data().classes);
    });
  }
  ...
  // Function to populate select element with Firestore data
</script>
...
>
  <div
    class="container flex flex-col flex-wrap items-center pt-2 mx-auto md:flex-row"
  >
    ...
    <div
      class="inline-flex items-center h-full lg:w-2/5 lg:justify-end lg:ml-0"
    >
      <button class="dropdown dropdown-end">
        ...
        >
          <li class="rounded-md hover:bg-gray-200">
            <a href="/.." class="ml-12 py-2 flex align-center font-medium"
              >Settings</a
            >
          </li>
          <li class="rounded-md hover:bg-gray-200">
            <a href="/.." class="ml-12 py-2 flex text-center font-medium"
              >Log out</a
            >
          </li>
        </ul>
            ...
            <div class="max-w-md mx-auto">
              ...
              <div class="m-7">
                <div class="mb-6">
                  <label
                    for="class"
                    class="block mb-2 text-md font-medium text-gray"
                    >Add Class</label
                  >
                  <input
